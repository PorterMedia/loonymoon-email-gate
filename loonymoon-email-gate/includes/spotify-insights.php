    ...
    ob_start(); ?>
        ...
        <div style="<?php echo $card; ?>margin-bottom:14px;">
            ...
            <div style="display:flex;align-items:stretch;gap:0;overflow-x:auto;padding:2px 0 6px;">
                ...
                <div style="flex:1 1 0;min-width:150px;background:radial-gradient(120% 90% at 0% 0%,rgba(255,255,255,.22),transparent 55%),linear-gradient(135deg,<?php echo $tone; ?> 0%,<?php echo $deep; ?> 100%);border:1px solid rgba(255,255,255,.22);border-radius:12px;padding:12px 30px 10px;color:#fff;box-shadow:0 10px 26px <?php echo $tone; ?>44;">
