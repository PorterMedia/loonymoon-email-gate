            ...
            <?php else : foreach ($rows as $d) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?php if ($d->presale_url) : ?><a class="button" href="<?php echo esc_url(admin_url('admin.php?page=lmeg-compose&prefill=presale&tour=' . (int) $d->id)); ?>" title="Draft a presale announcement (email, SMS + a free Apple Wallet push) for <?php echo esc_attr($d->city); ?>">🎟️ Announce presale</a><?php endif; ?>
