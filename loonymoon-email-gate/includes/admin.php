            ...
            <table class="form-table" role="presentation">
                ...
                <tr><th>Daily brief</th>
                    <td><label><input type="checkbox" name="brief_enabled" value="1" <?php checked(!isset($s['brief_enabled']) || !empty($s['brief_enabled'])); ?> /> Email me a daily Spotify brief every morning</label>
                        ...
                        <p class="description">Yesterday’s streams, the five rings, songs that moved, what to do, playlist pickups — sent once the day’s Spotify for Artists capture lands. Only on sites with Spotify for Artists attached. Blank = digest address, then site admin email. Preview: Social → Spotify Insights → “Email me today’s brief”.</p></td></tr>
